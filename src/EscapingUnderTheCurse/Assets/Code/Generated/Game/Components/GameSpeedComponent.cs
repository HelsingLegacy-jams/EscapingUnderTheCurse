...
public partial class GameEntity {
    ...
    public Code.Features.Movement.Speed speed { get { return (Code.Features.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Code.Features.Movement.Speed)CreateComponent(index, typeof(Code.Features.Movement.Speed));
